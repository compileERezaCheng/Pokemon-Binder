...
Source: "Run_Game.bat"; DestDir: "{app}"; Flags: ignoreversion

[Icons]
Name: "{group}\Pokemon Binder Manager"; Filename: "{app}\Run_Game.bat"; IconFilename: "{app}\Pokemon Binder.exe"
Name: "{autodesktop}\Pokemon Binder Manager"; Filename: "{app}\Run_Game.bat"; IconFilename: "{app}\Pokemon Binder.exe"; Tasks: desktopicon

[Run]
Filename: "{app}\Run_Game.bat"; Description: "{cm:LaunchProgram,Pokemon Binder Manager}"; Flags: nowait postinstall skipifsilent
